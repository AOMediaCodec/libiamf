...
#ifndef __IAMF_CORE_DECODER_H__
#define __IAMF_CORE_DECODER_H__
...
typedef struct IamfCoreDecoder iamf_core_decoder_t;
 ...
 * @return    @ref IAErrCode.
 */
int iamf_core_decoder_decode(iamf_core_decoder_t *ths, uint8_t *buffers[],
