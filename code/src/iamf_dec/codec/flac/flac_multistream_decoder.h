...
#ifndef __FLAC_MULTISTREAM2_DECODER_H__
#define __FLAC_MULTISTREAM2_DECODER_H__

#include <stdint.h>

typedef struct FlacMsDecoder flac_ms_decoder_t;
...
#endif /* __FLAC_MULTISTREAM2_DECODER_H__ */
