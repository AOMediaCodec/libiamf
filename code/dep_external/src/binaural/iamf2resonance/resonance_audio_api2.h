...
EXPORT_API void* CreateResonanceAudioApi2(
...
EXPORT_API int FillInterleavedOutputBufferFloat(void* pv_thiz, size_t num_channels,
      size_t num_frames,
      float* buffer_ptr);
  ...
  // @return True if a valid output was successfully rendered, false otherwise.
EXPORT_API int FillInterleavedOutputBufferInt16(void* pv_thiz, size_t num_channels,
      size_t num_frames,
      int16 * buffer_ptr);
  ...
  //    the audio buffer.
  // @return True if a valid output was successfully rendered, false otherwise.
EXPORT_API int FillPlanarOutputBufferFloat(void* pv_thiz, size_t num_channels, size_t num_frames,
  ...
  //    the audio buffer.
  // @return True if a valid output was successfully rendered, false otherwise.
EXPORT_API int FillPlanarOutputBufferInt16(void* pv_thiz, size_t num_channels, size_t num_frames,
...
EXPORT_API void SetHeadRotationXYZW(void* pv_thiz, float x, float y, float z, float w);
...
EXPORT_API SourceId CreateSoundObjectSource(void* pv_thiz, RenderingMode2 rendering_mode);
...
EXPORT_API void SetSourcePosition(void* pv_thiz, SourceId source_id, float x, float y,
    float z);
...
EXPORT_API void SetSourceRoomEffectsGain(void* pv_thiz, SourceId source_id,
  ...
  // @param z Z component of quaternion.
  // @param w W component of quaternion.
EXPORT_API void SetSourceRotation(void* pv_thiz, SourceId source_id, float x, float y, float z,
    float w);
  ...
  //     attenuation, range [1, inf) for gain boost.
EXPORT_API void SetSourceVolume(void* pv_thiz, SourceId source_id, float volume);
...
EXPORT_API void SetSoundObjectDirectivity(void* pv_thiz, SourceId sound_object_source_id,
...
EXPORT_API void SetSoundObjectListenerDirectivity(void* pv_thiz,
  ...
  //     approx. (-Inf, +20dB]).
EXPORT_API void SetSoundObjectNearFieldEffectGain(void* pv_thiz,
...
EXPORT_API void SetSoundObjectOcclusionIntensity(void* pv_thiz, SourceId sound_object_source_id,
    float intensity);
...
EXPORT_API void SetSoundObjectSpread(void* pv_thiz, SourceId sound_object_source_id,
    float spread_deg);
...
EXPORT_API void SetReflectionProperties(void* pv_thiz,
