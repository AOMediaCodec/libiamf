...
#ifndef __AAC_MULTISTREAM2_DECODER_H__
#define __AAC_MULTISTREAM2_DECODER_H__

#include <stdint.h>

typedef struct AacMsDecoder aac_ms_decoder_t;
...
#endif /* __AAC_MULTISTREAM2_DECODER_H__ */
