...
#ifndef __OPUS_MULTISTREAM2_DECODER_H__
#define __OPUS_MULTISTREAM2_DECODER_H__

#include <stdint.h>

typedef struct OpusMs2Decoder Opus_Ms2_Decoder_t;
...
#endif /* __OPUS_MULTISTREAM2_DECODER_H__ */
